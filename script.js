...
function setSavedCodeHistory(){
  db.myTable.get(1).then((result) => {
    var retrievedArray = result.data;
...
//window.addEventListener('unload', saveCodeHistory);
//window.addEventListener('load', setSavedCodeHistory).
